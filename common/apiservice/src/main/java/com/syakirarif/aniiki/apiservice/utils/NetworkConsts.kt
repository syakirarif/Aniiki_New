...
object NetworkConsts {
    ...
    const val CODE_502 = "Bad Gateway"
    const val CODE_503 = "Service Unavailable"
    const val CODE_504 = "Gateway Timeout"
    const val CODE_511 = "Network Authentication Required"
